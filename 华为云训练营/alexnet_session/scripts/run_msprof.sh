...
python3.7 ${MSPROF_DIR}/msprof.pyc query -dir ${PROFILING_DIR}
echo "===>>>[OK] msprof query.\n"

python3.7 ${MSPROF_DIR}/msprof.pyc export timeline -dir ${PROFILING_DIR}
echo "===>>>[OK] msprof timeline.\n"

python3.7 ${MSPROF_DIR}/msprof.pyc export summary -dir ${PROFILING_DIR}
